"""
models.py
Aqui viven las clases que representan las tablas de la base de datos.

Producto hereda de db.Model (SQLAlchemy). Las subclases usan herencia
polimorfica: todo se guarda en la misma tabla y la columna tipo indica
que clase reconstruir al leer los datos.
"""
